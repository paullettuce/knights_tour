...
class ChessBoardWindow(pyglet.window.Window, KnightsControllerInterface):
    ...
    def __init__(self, board, start_finding_tour, *args, **kwargs):
        ...
        self._chessman_painter = ChessmanPainter()
